    ...
    <>
      ...
      <div className="mx-auto mt-8 flex flex-col items-center justify pt-20 gap-20">
          ...
          <div>
            ...
            <div style={{"grid-template-columns": "repeat( auto-fill, minmax(170px, 1fr) )"}} className="w-full  items-center justify-center grid  mt-8 ">
              <img
              ...
              <img
                ...
                src="https://preview.thenewsmarket.com/Previews/ADID/StillAssets/1920x1080/600894.jpg"
                alt=""
              />
              <img
